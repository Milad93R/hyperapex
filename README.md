...
- **PWA Support**: Progressive Web App with offline functionality, installable on mobile and desktop
...
This application is configured as a Progressive Web App and can be installed on mobile devices and desktop browsers.

### Features

- **Offline Support**: Service worker caches API responses and static assets
- **Installable**: Users can install the app on their home screen or desktop
- **App-like Experience**: Standalone display mode with custom theme colors
- **Smart Caching**: 
  - Binance API: 1 hour cache
  - Hyperliquid API: 1 hour cache
  - Internal APIs: 5 minutes cache
...
- **Development**: PWA is disabled in development mode for faster builds
- **Production**: After building (`npm run build`), the service worker will be generated
- **Install**: Users can install via browser menu (Chrome: "Install App", Safari: "Add to Home Screen")

### PWA Configuration

- Manifest: `public/manifest.json`
- Service Worker: Auto-generated by `next-pwa` in production builds
